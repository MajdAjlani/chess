/* our board represntation
Note: due to javascript doesn't support 2D array, we use 1D array instead.
Note: we use 120 board represntation instead of 64 board represntation 
becasuse it more comfortable for us to check if we are out of the board.
